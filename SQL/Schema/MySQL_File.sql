...
BEGIN
	INSERT INTO `File` (userId,fileName,uploadIP,uploadDate,fileSize,fileType,isPublic,categoryTypeId)
	VALUES (paramuserId, paramfileName, paramuploadIP, paramuploadDate, paramfileSize, paramfileType, paramisPublic, paramcategoryTypeId);
